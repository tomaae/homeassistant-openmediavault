...
class OMVControllerData(object):
    ...
    def get_disk(self):
        ...
        self.data["disk"] = parse_api(
            ...
            ensure_vals=[
                {"name": "devicemodel", "default": None},
                {"name": "serialnumber", "default": None},
                {"name": "firmwareversion", "default": None},
                {"name": "sectorsize", "default": None},
                {"name": "rotationrate", "default": None},
                {"name": "writecacheis", "default": None},
                {"name": "smartsupportis", "default": None},
                {"name": "Raw_Read_Error_Rate", "default": None},
                {"name": "Spin_Up_Time", "default": None},
                {"name": "Start_Stop_Count", "default": None},
                {"name": "Reallocated_Sector_Ct", "default": None},
                {"name": "Seek_Error_Rate", "default": None},
                {"name": "Load_Cycle_Count", "default": None},
                {"name": "Temperature_Celsius", "default": None},
                {"name": "UDMA_CRC_Error_Count", "default": None},
                {"name": "Multi_Zone_Error_Rate", "default": None},
            ],
        )
    ...
    def get_fs(self):
        ...
        self.data["fs"] = parse_api(
            ...
            vals=[
                {"name": "uuid"},
                {"name": "parentdevicefile", "default": None},
                {"name": "label", "default": None},
                {"name": "type", "default": None},
                {"name": "mountpoint", "default": None},
                {"name": "available", "default": None},
                {"name": "size", "default": None},
                {"name": "percentage", "default": None},
